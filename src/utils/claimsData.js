...
export const generateClaimsData = () => {
  ...
  // Disability claims - aligned with Sample Data conditions (STD/LTD flow)
  const disabilityClaims = [
    {
      id: 'CLM-DIS-001-BACK',
      claimNumber: 'SLF-DIS-880012',
      ...
      disabilityStartDate: '2025-01-02',
      lastWorkingDate: '2025-01-01',
      expectedReturnDate: '2025-02-15',
      extractionAssets: {
        pdfPath: '/data/disability/Back Injury/Employee\'s Statement (Form 490L-M-12500-E)_Back Injury.pdf',
        jsonPath: null,
      },
    },
    {
      id: 'CLM-DIS-002-MDD',
      claimNumber: 'SLF-DIS-880045',
      ...
      dentist: null,
      procedureCount: 0,
      integrationType: 'Pega',
      rawData: null,
      claimType: 'disability',
      benefitType: 'STD',
      diagnosis: 'Major Depressive Disorder',
      disabilityStartDate: '2024-11-15',
      lastWorkingDate: '2024-11-14',
      expectedReturnDate: '2025-01-20',
      extractionAssets: {
        pdfPath: '/data/disability/Major Depressive Disorder/Employee\'s Statement (Form 490L-M-12500-E)MDD.pdf',
        jsonPath: null,
      },
    },
    {
      id: 'CLM-DIS-003-FRACTURE',
      claimNumber: 'SLF-DIS-880078',
      ...
      benefitType: 'STD',
      diagnosis: 'Fracture',
      disabilityStartDate: '2025-01-05',
      lastWorkingDate: '2025-01-04',
      expectedReturnDate: '2025-03-01',
      extractionAssets: {
        pdfPath: '/data/disability/Fracture/Employee\'s Statement (Form 490L-M-12500-E)_Fracture.pdf',
        jsonPath: null,
      },
    },
    {
      id: 'CLM-DIS-004-PNEUMONIA',
      claimNumber: 'SLF-DIS-880091',
      ...
      disabilityStartDate: '2024-12-10',
      lastWorkingDate: '2024-12-09',
      expectedReturnDate: '2025-01-25',
      extractionAssets: {
        pdfPath: '/data/disability/Severe pneumonia/Employee\'s Statement (Form 490L-M-12500-E)_Severe pneumonia.pdf',
        jsonPath: null,
      },
    },
    {
      id: 'CLM-DIS-005-LTD',
      claimNumber: 'SLF-DIS-LTD-770033',
      patientName: 'DAVID WONG',
      memberId: 'DIS-LTD-770033',
      city: 'Ottawa',
      province: 'ON',
      status: 'pending',
      amount: 0,
      ...
      disabilityStartDate: '2024-06-01',
      lastWorkingDate: '2024-05-28',
      expectedReturnDate: null,
      extractionAssets: {
        pdfPath: '/data/disability/Multiple sclerosis/Employee\'s Statement (Form 490L-M-12500-E).pdf',
        jsonPath: null,
      },
    },
    {
      id: 'CLM-DIS-006-KIDNEY',
      claimNumber: 'SLF-DIS-880102',
      ...
      disabilityStartDate: '2024-11-20',
      lastWorkingDate: '2024-11-19',
      expectedReturnDate: null,
      extractionAssets: {
        pdfPath: '/data/disability/Kidney Failure/Employee\'s Statement (Form 490L-M-12500-E).pdf',
        jsonPath: null,
      },
    },
    {
      id: 'CLM-DIS-007-BURNS',
      claimNumber: 'SLF-DIS-880115',
      ...
      benefitType: 'STD',
      diagnosis: 'Burns',
      disabilityStartDate: '2025-01-06',
      lastWorkingDate: '2025-01-05',
      expectedReturnDate: '2025-02-28',
      extractionAssets: {
        pdfPath: '/data/disability/Burns/Employee\'s Statement (Form 490L-M-12500-E)_burns.pdf',
        jsonPath: null,
      },
    },
    {
      id: 'CLM-DIS-008-AMP',
      claimNumber: 'SLF-DIS-LTD-770048',
      patientName: 'NANCY FOSTER',
      memberId: 'DIS-LTD-770048',
      city: 'Winnipeg',
      province: 'MB',
      status: 'accepted',
      amount: 0,
      ...
      claimType: 'disability',
      benefitType: 'LTD',
      diagnosis: 'Loss of Limb-Amputation',
      disabilityStartDate: '2024-09-20',
      lastWorkingDate: '2024-09-19',
      expectedReturnDate: null,
      extractionAssets: {
        pdfPath: '/data/disability/Loss of Limb-Amputation/Employee\'s Statement (Form 490L-M-12500-E).pdf',
        jsonPath: null,
      },
    },
  ]
  claims.push(...disabilityClaims)
